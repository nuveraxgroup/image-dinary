...
export const ModifyImgRouter = async (req: functions.Request, res: functions.Response) => {
    ...
    res
        ...
        .setHeader('Content-Type', supportedImageContentTypeMap[parsedPath.ext.replace(".", "").toLowerCase()])
