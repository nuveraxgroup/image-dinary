...
export const editImage = async ({
    ...
    if (params.rotate) {
        ...
        logs.imageChanges( `Rotate: ${params.rotate} background: ${params.backgroundColor}`)
    }
    if (params.sharpen) {
        sharpImg.sharpen({
    ...
    if (params.quality) {
        ...
        logs.imageChanges( `Quality: ${qu} format=${metadata.format} jpgCompression=${params.jpgCompression} pngCompression=${params.pngCompression}`)
    }
    if (params.scale) {
        ...
        logs.imageChanges( `Scale: ${finalScale} background: ${params.backgroundColor}`)
        ...
        const h = params.resize.height ? Math.round(params.resize.height): undefined
